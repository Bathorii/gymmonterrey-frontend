// src/app/entrenadores/santa-maria-la-ribera/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-santa-maria-la-ribera'
...
export default function EntrenadoresSantaMariaLaRiberaPage() {
  return (
    <BarrioPage
