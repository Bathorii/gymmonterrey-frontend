// src/app/entrenadores/narvarte-poniente/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-narvarte-poniente'
...
export default function EntrenadoresNarvartePonientePage() {
  return (
    <BarrioPage
