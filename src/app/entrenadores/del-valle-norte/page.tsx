// src/app/entrenadores/del-valle-norte/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-del-valle-norte'
...
export default function EntrenadoresDelValleNortePage() {
  return (
    <BarrioPage
