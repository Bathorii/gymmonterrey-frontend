// src/app/entrenadores/narvarte-oriente/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-narvarte-oriente'
...
export default function EntrenadoresNarvarteOrientePage() {
  return (
    <BarrioPage
