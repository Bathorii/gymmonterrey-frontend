// src/app/entrenadores/del-valle-centro/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-del-valle-centro'
...
export default function EntrenadoresDelValleCentroPage() {
  return (
    <BarrioPage
