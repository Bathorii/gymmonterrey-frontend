// src/app/entrenadores/portales-norte/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-portales-norte'
...
export default function EntrenadoresPortalesNortePage() {
  return (
    <BarrioPage
