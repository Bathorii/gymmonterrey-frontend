// src/app/entrenadores/fuentes-del-pedregal/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-fuentes-del-pedregal'
...
export default function EntrenadoresFuentesDelPedregalPage() {
  return (
    <BarrioPage
