// src/app/entrenadores/jardin-balbuena/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-jardin-balbuena'
...
export default function EntrenadoresJardinBalbuenaPage() {
  return (
    <BarrioPage
