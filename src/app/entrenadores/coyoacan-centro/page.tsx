// src/app/entrenadores/coyoacan-centro/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-coyoacan-centro'
...
export default function EntrenadoresCoyoacanCentroPage() {
  return (
    <BarrioPage
