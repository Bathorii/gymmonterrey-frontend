// src/app/entrenadores/hipodromo-condesa/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-hipodromo-condesa'
...
export default function EntrenadoresHipodromoCondesaPage() {
  return (
    <BarrioPage
