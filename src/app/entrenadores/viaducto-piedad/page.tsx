// src/app/entrenadores/viaducto-piedad/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-viaducto-piedad'
...
export default function EntrenadoresViaductoPiedadPage() {
  return (
    <BarrioPage
