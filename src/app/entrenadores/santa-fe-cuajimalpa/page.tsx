// src/app/entrenadores/santa-fe-cuajimalpa/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-santa-fe-cuajimalpa'
...
export default function EntrenadoresSantaFeCuajimalpaPage() {
  return (
    <BarrioPage
