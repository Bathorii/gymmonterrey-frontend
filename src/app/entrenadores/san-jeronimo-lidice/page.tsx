// src/app/entrenadores/san-jeronimo-lidice/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-san-jeronimo-lidice'
...
export default function EntrenadoresSanJeronimoLidicePage() {
  return (
    <BarrioPage
