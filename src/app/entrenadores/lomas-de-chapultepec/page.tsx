// src/app/entrenadores/lomas-de-chapultepec/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-lomas-de-chapultepec'
...
export default function EntrenadoresLomasDeChapultepecPage() {
  return (
    <BarrioPage
