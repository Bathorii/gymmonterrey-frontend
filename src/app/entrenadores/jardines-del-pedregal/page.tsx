// src/app/entrenadores/jardines-del-pedregal/page.tsx
import type { Metadata } from 'next'
import { baseOpenGraph, OG_IMAGE } from '@/lib/metadata'
import { city } from '@/config/city'
import { barrioContent } from '@/data/cdmx/barrio-jardines-del-pedregal'
...
export default function EntrenadoresJardinesDelPedregalPage() {
  return (
    <BarrioPage
