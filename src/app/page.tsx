...
export const metadata: Metadata = {
  title: `Gimnasios y Fitness en ${city.name} | ${city.siteName}`,
  description: `Directorio de gimnasios, estudios fitness y entrenadores en ${city.name}. Más de 1.500 lugares en 400 colonias. Busca gratis por colonia.`,
  alternates: { canonical: `${city.baseUrl}/` },
  openGraph: baseOpenGraph({
    title: `Gimnasios en ${city.name} – ${city.siteName}`,
    description: `El directorio de fitness más completo de ${city.name}. 1.500+ gimnasios, estudios y entrenadores en 400+ colonias. Busca por colonia, gratis.`,
    url: `${city.baseUrl}/`,
  }),
