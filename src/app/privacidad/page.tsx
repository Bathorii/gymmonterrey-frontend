...
export const metadata: Metadata = {
  ...
  description:
    `Conoce cómo ${city.siteName} recopila, usa y protege tus datos personales conforme al Reglamento General de Protección de Datos (RGPD) y la normativa de México.`,
...
const PRIVACY_EMAIL = 'privacidad@gymmonterrey.com'

const sections = [
  {
    title: '1. Responsable del tratamiento',
    body: `El responsable del tratamiento de los datos personales recopilados a través de ${BRAND} es:\n\n${CONTROLLER} · ${CONTROLLER_COUNTRY}\n\nEl sitio web ${city.siteName} es operado por ${CONTROLLER}, empresa con sede en la Unión Europea. Como empresa europea, el tratamiento de datos se rige principalmente por el Reglamento General de Protección de Datos (RGPD / GDPR, Reglamento UE 2016/679), aplicando además las disposiciones de la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) de México en lo que respecta a los usuarios residentes en México.\n\nPara cualquier consulta sobre privacidad: ${PRIVACY_EMAIL}`,
  },
  {
    ...
    <>
      ...
      <section style={{ maxWidth: 780, margin: '48px auto', padding: '0 24px 64px' }}>
        ...
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#374151', marginBottom: 40 }}>
          ...
          <strong>Ley Federal de Protección de Datos Personales en Posesión de los Particulares</strong> de México.
        </p>
